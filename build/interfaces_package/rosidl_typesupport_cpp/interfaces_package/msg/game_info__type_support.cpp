...
static const _GameInfo_type_support_symbol_names_t _GameInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_package, msg, GameInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces_package, msg, GameInfo)),
  }
};
...
{
  return &::interfaces_package::msg::rosidl_typesupport_cpp::GameInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces_package, msg, GameInfo)() {
  return get_message_type_support_handle<interfaces_package::msg::GameInfo>();
}
